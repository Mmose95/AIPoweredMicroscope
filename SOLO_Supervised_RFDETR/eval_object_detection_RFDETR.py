...
def run_evaluate_mode(args: argparse.Namespace) -> None:
    ...
    summary = {
        ...
        "schema_version": 2,
        "analysis_stages": {
            "coco_standard": "coco_ranking",
            "operating_point": "calibrated_test_detection",
            "confusion_matrix": "calibrated_test_detection",
            "count_error_metrics": "calibrated_test_detection",
        },
        "count_error_analysis": {
            "unit": "test_patch",
            "class_score_thresholds": resolved_class_thresholds,
